# Running Karyon calculator with Jenkins jobs
...
4. Go to `Build Environment` -> `Generic-Artifactory Integration` -> On Upload Details choose the configured Artifactory, then go to Upload spec source, choose Job Configuration and paste the Spec:
   <pre>
      {
          "files": [
              {
